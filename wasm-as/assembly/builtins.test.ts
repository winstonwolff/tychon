...
describe('bulitins.ts', ():void => {
  ...
  describe('define()', ():void => {
    it('saves a value in "scope"', ():void => {
      ...
      define(scope, new tyv.List([new tyv.String("my_var"), new tyv.String("Teapot")]))
    ...
    it('returns the value', ():void => {
      const scope = new Dictionary()
      const result = define(scope, new tyv.List([new tyv.String("my_var"), new tyv.String("Teapot")]))
